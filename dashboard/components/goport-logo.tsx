...
export function GoPortLogo({ className = "" }: GoPortLogoProps) {
  return (
    ...
    >
      ...
      <circle cx="212" cy="160" r="26" fill="var(--card)" />
      <circle cx="212" cy="160" r="18" fill="none" stroke="var(--primary)" strokeWidth="1.5" opacity="0.75" />
      ...
      <circle cx="420" cy="160" r="26" fill="var(--card)" />
      <ellipse cx="420" cy="160" rx="14" ry="18" fill="none" stroke="var(--primary)" strokeWidth="1.5" opacity="0.75" />
      <ellipse cx="420" cy="160" rx="5" ry="7" fill="var(--primary)" opacity="0.9" />
